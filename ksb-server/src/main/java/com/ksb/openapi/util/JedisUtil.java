...
//	}
	...
	public class Geos{
		 ...
		 * 向redis中写入空间对象 
		 **/
		public long geoset(String key,double y,double x,String value){
			Jedis jedis = getJedis();
			long s = jedis.geoset(key, y, x, value);
			returnJedis(jedis);
			return s;
		}
		 ...
		 * 根据经纬度周边查询
		 */
		public List<String> geoscanByRadius(String key,double y,double x,GeoParams geoParam){
			Jedis jedis = getJedis();
			List<String> rsList = jedis.geoscanByRadius(key, y, x, geoParam);
			returnJedis(jedis);
			return rsList;
		}
		 ...
		 * 根据数据名称周边查询
		 * */
		public List<String> geoscanByName(String key,String name,GeoParams geoParam){
			Jedis jedis = getJedis();
			List<String> rsList = jedis.geoscanByName(key, name, geoParam);
			returnJedis(jedis);
			return rsList;
		}
